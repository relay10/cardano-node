...
mkNoNodesInfo networkConfig = do
 ...
 where
  intro =
    "If your nodes should already be connected, please check your configuration files."
  ...
  nodeNameNote =
    "Also, please add a meaningful name for your nodes using <code>TraceOptionNodeName</code> section. "
